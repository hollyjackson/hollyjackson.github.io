...
### During the Spring 2021 semester at MIT, I analyzed over 33,000 *New York Times* articles on Palestine and Israel using machine learning methods.  In this study, In this study, I provide a methodologically novel, large-scale proof of historical bias against Palestine in *The New York Times*.
